...
export default class ChartsActivity extends PureComponent {
  renderTooltip = (props) => {
  ...
  render() {
    ...
    return (
      <div>
        <div className="text-xl text-center">Daily Activity</div>
        <br />
        <div className="h-[500px] bg-slate-800 p-4 rounded-md">
